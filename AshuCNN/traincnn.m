function cnn=traincnn(cnn,x,y, no_of_epochs,batch_size, BITS)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         yy =y(j:j+batch_size-1);
        cnn=ffcnn(cnn, xx, BITS);
        j
        cnn = bpcnn(cnn,yy, BITS);
        cnn =gradientdescentcnn(cnn, BITS);

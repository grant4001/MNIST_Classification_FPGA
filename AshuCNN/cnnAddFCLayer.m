function cnn=cnnAddFCLayer(cnn, no_of_nodes, activation_func, BITS)
...
cnn.layers{l}.W = s_quantize( 0.5*rand([no_of_nodes cnn.layers{l}.no_of_inputs]) -0.25 , BITS);
cnn.layers{l}.b = s_quantize( 0.5*rand([no_of_nodes 1]) - 0.25 , BITS);

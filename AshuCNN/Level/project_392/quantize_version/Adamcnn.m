...
% Beta_2 normally have value of 0.999       %
% epsi  normally have value of 10^(-8)      %
% crt_t =  no_of_epoch                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i = 2 : cnn.no_of_layers
    if cnn.layers{i}.type == 'f'
        ...
        S_dW_crt_rt = S_dW_crt  ^ 0.5 + epsi;
        S_db_crt_rt = S_db_crt  ^ 0.5 + epsi;
    ...
    elseif cnn.layers{i}.type == 'c'
        ...
        S_dK_crt_rt = S_dK_crt  .^ 0.5 + epsi * ones(feature_height,feature_width);
        S_db_crt_rt = S_db_crt  .^ 0.5 + epsi ;
